      ...
      <DialogContent className="sm:max-w-md bg-navy-800 border-navy-700 text-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-sand-400">
            Securely access your enterprise AI operating system.
          </DialogDescription>
        </DialogHeader>
        <div className="flex flex-col space-y-4 py-4">
          <Button
            ...
            disabled={isLoading}
            variant="outline"
            className="w-full bg-white text-navy-900 hover:bg-sand-100 border-none h-12 text-base font-semibold transition-all flex items-center justify-center space-x-3"
          >
